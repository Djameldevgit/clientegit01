...
const ListUsers3h= () => {
  ...
  const handleLoadMore = async () => {
    ...
    dispatch({
      ...
      payload:  res.data.users, page: homeUsers.activeLast3hUsers.page + 1  
    });
  ...
  return (
    <div className="container mt-5">
      ...
      <LoadMoreBtn result={homeUsers.activeLast3hUsers.result} page={homeUsers.activeLast3hUsers.page} load={load} handleLoadMore={handleLoadMore} />
    </div>
  );
};
